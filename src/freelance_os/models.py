...
class Lead(SQLModel, table=True):
    ...
    reason_codes: Optional[str] = None  # JSON-encoded list
...
class ProposalDraft(SQLModel, table=True):
    ...
    portfolio_matches: Optional[str] = None  # JSON-encoded list
    clarifying_questions: Optional[str] = None
    price_recommendation: Optional[str] = None
    validator_flags: Optional[str] = None  # JSON-encoded list
...
class PortfolioItem(SQLModel, table=True):
    ...
    description: Optional[str] = None
    tech_stack: Optional[str] = None      # JSON-encoded list
    proof_points: Optional[str] = None    # JSON-encoded list
    links: Optional[str] = None           # JSON-encoded list
    allowed_claims: Optional[str] = None  # JSON-encoded list
    forbidden_claims: Optional[str] = None  # JSON-encoded list
...
class ClientProject(SQLModel, table=True):
    ...
    status: Optional[str] = Field(default="INTAKE")
